...
# Prueba de la clase Comment
if __name__ == "__main__":
    # Agregar un comentario
    Comment.addComment()
    
    # Obtener un comentario por ID
    comment_id = input("Ingrese el ID del comentario para obtener los detalles: ")
    comment_details = Comment.getCommentById(comment_id)
    if comment_details:
        print(f"Detalles del comentario: {comment_details}")
    else:
        print("No se encontró ningún comentario con ese ID.")
